...
if __name__=="__main__":
    base = Path("1_backdoor/25data-100op-mnist")
    #approach = "lwf"
    ...
    for approach,ax in zip(approaches,axes):
        ...
        labels = ["mnist-task1","mnist-task2","mnist-task3","mnist-task4","mnist-task5", "mnist-clean"]
    ...
    plt.savefig(f"fig51_25data.png",bbox_inches='tight')