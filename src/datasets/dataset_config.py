...
dataset_config = {
    ...
    'cifar_10_mnemonic': {# clean-label feature confusion across tasks
        'path': join(_BASE_DATA_PATH, 'mnemonic-code'),
        'resize': None,
        'pad': 4,
        'crop': 32,
        'flip': True,
    ...
    },'cifar_10_blending': {# clean-label feature confusion across tasks
        'path': join(_BASE_DATA_PATH, 'blend-random'),
        'resize': None,
        'pad': 4,
        'crop': 32,
        'flip': True,
