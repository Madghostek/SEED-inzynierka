...
#SBATCH --job-name=finetuning-mnemonic-20op-testpoison
#SBATCH --ntasks=4                    
#SBATCH --gpus=1
#SBATCH --mem=4gb                     # Job memory request
#SBATCH --time=03:00:00               # Time limit hrs:min:sec
#SBATCH --output=finetuning-mnemonic-20op-twocode-testpoison #%j to jobid

DATASET_NAME=opacity20-twocode-testpoison
